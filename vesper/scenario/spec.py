...
class ScenarioSpec:
    ...
    # terrain: {"usd": "assets/<name>/<file>.usd" (repo-relative), "translation": [x,y,z] world,
    #           "rotation_xyz_deg": [rx,ry,rz], "scale": s}; None -> flat default environment
